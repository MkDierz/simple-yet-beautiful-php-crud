...
include "config.php"; 
$id=$_GET['id'];
$edit="SELECT * FROM t_dosen WHERE id='$id'";
...
<body class="bg-gray-300">
    ...
    <div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-2 mb-10">
        ...
        <div id='recipients' class="p-2 mt-6 lg:mt-0 rounded shadow bg-gray-100">
            ...
            <form method="GET" action="edit-process.php">
                ...
                <div class="md:flex mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" name="nip-dosen" type="number" value="<?= $row['Nip_Dosen']?>">
                    </div>
                </div>
                ...
                <div class="md:flex mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" name="nama-dosen" type="text" value="<?= $row['Nama_Dosen']?>">
                    </div>
                </div>
                <div class="md:flex mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" name="jurusan" type="text" value="<?= $row['Jurusan']?>">
                    </div>
                </div>
                <div class="md:flex mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" name="telepon" type="text" value="<?= $row['Telepon']?>">
                    </div>
                </div>
                <div class="md:flex mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" name="matakuliah" type="text" value="<?= $row['Mata_Kuliah']?>">
                    </div>
                </div>
                <div class="md:flex mb-6">
                    <div class="md:w-1/3">
                    ...
                    <div class="md:w-2/3">
                        <input class="form-input block w-full focus:bg-white" name="sks" type="text" value="<?= $row['jumlah_sks']?>">
                    </div>
                </div>

                <input type="number" hidden="true" value="<?= $row['id']?>" name="id">
